...
import heroStyles from './HomeHeroV4.module.css';
...
function BrowserPreview() {
  return (
    <div className={heroStyles.browserDevice} aria-hidden="true">
      <div className={heroStyles.browserFrame}>
        <div className={heroStyles.browserToolbar}>
          <div className={heroStyles.browserDots}>
            <span />
            <span />
            <span />
          </div>
          <span className={heroStyles.browserAddress} />
        </div>

        <div className={heroStyles.browserBody}>
          <div className={heroStyles.browserSidebar}>
            <span />
            <span />
            <span />
            <span />
          ...
          <div className={heroStyles.browserCanvas}>
            <span className={heroStyles.browserHeadline} />
            <span className={heroStyles.browserLineLong} />
            <span className={heroStyles.browserLineShort} />
            <div className={heroStyles.browserTiles}>
              <span />
              <span />
              <span />
            </div>
      ...
      <span className={heroStyles.laptopBase} />
    </div>
  );
}
...
function PhonePreview() {
  return (
    <div className={heroStyles.phoneDevice} aria-hidden="true">
      <div className={heroStyles.phoneFrame}>
        <span className={heroStyles.phoneSpeaker} />
        <div className={heroStyles.phoneScreen}>
          <div className={heroStyles.phoneTopline}>
            <span />
            <span />
          </div>
          <span className={heroStyles.phoneFeature} />
          <span className={heroStyles.phoneLineLong} />
          <span className={heroStyles.phoneLineMedium} />
          <span className={heroStyles.phoneLineShort} />
          <div className={heroStyles.phoneNavigation}>
            <span />
            <span />
            <span />
          </div>
...
const CONTENT = {
  ru: {
    ...
    heroMeta: ['Web', 'Mobile', 'Product design'],
    heroCards: [
      {
        type: 'web',
        title: 'Высокопроизводительные сайты',
        text: 'Быстрые адаптивные веб-продукты с чистой архитектурой и точным визуальным языком.',
        href: '/projects_ru',
      },
      {
        type: 'mobile',
        title: 'Высокопроизводительные мобильные приложения',
        text: 'Приложения для Android и iOS с быстрым откликом, понятной логикой и надёжной архитектурой.',
        href: '/projects_ru',
      },
    ],
    servicesEyebrow: 'Направления',
    servicesTitle: 'Минимализм, наполненный глубиной',
    servicesLead:
    ...
    services: [
      {
        ...
        text: 'Быстрые, адаптивные и визуально цельные веб-продукты — от лендинга до сложного сервиса',
        tags: ['Архитектура', 'Интерфейс', 'Скорость'],
      },
      {
        number: '02',
        icon: Smartphone,
        title: 'Мобильные приложения',
        text: 'Мультиплатформенные приложения с продуманной логикой, удобной навигацией и единым дизайн-языком',
      ...
      },
      {
        ...
        text: 'Аналитика, контент и развитие продукта, которые превращают внимание аудитории в измеримый результат',
        tags: ['Аналитика', 'Контент', 'Рост'],
      },
    ],
    aboutEyebrow: 'О студии',
    aboutTitle: 'Разрабатываем не отдельные экраны, а цельные цифровые системы',
    aboutParagraphs: [
    ...
    stats: [
      ['01', 'Единая архитектура'],
      ['02', 'Адаптивный интерфейс'],
      ['03', 'Долгосрочное развитие'],
    ],
    contactEyebrow: 'Связь',
    contactTitle: 'Давайте превратим вашу идею в продукт',
    contactLead:
      'Опишите задачу, приложите референсы или готовый дизайн — мы обсудим архитектуру, визуальное направление и план реализации.',
    contactAction: 'Написать в Telegram',
    saveContactAction: 'Сохранить контакт',
  ...
  en: {
    ...
    heroCards: [
      {
        ...
        text: 'Fast responsive web products with clean architecture and a precise visual language.',
        href: '/projects',
      },
      {
        type: 'mobile',
        title: 'High-performance mobile applications',
        text: 'Android and iOS applications with fast response, clear logic and reliable architecture.',
        href: '/projects',
      },
    ],
    servicesEyebrow: 'Expertise',
    servicesTitle: 'Minimalism with depth',
    servicesLead:
    ...
    services: [
      {
        ...
        text: 'Fast, responsive and visually consistent web products — from landing pages to complex services.',
        tags: ['Architecture', 'Interface', 'Performance'],
      },
      {
        number: '02',
        icon: Smartphone,
        title: 'Mobile applications',
        text: 'Cross-platform apps with thoughtful logic, clear navigation and a unified design language.',
        tags: ['Android', 'iOS', 'Flutter'],
      },
      {
        number: '03',
        ...
        text: 'Analytics, content and product growth that turn audience attention into measurable results.',
        tags: ['Analytics', 'Content', 'Growth'],
      },
    ],
    aboutEyebrow: 'About the studio',
    aboutTitle: 'We design complete digital systems, not isolated screens',
    aboutParagraphs: [
    ...
    stats: [
      ...
      ['03', 'Long-term evolution'],
    ],
    contactEyebrow: 'Contact',
    contactTitle: 'Let us turn your idea into a product',
    contactLead:
    ...
    contactAction: 'Message on Telegram',
...
export default function MonochromeHome({ locale = 'ru' }) {
  ...
  return (
    <main className={styles.page}>
          ...
          >
            ...
            >
              <animate
                ...
                dur="14s"
                values="0.008 0.018; 0.012 0.025; 0.008 0.018"
      ...
      <section
        className={`${styles.hero} ${heroStyles.heroV4}`}
        aria-labelledby="hero-title"
      >
        <div className={heroStyles.heroShell}>
          <header className={heroStyles.heroHeading}>
            <p className={heroStyles.eyebrow}>{copy.eyebrow}</p>
            <h1 id="hero-title" className={heroStyles.title}>
              {copy.title}
            </h1>
            <p className={heroStyles.subtitle}>{copy.subtitle}</p>
          </header>

          <div className={heroStyles.showcaseGrid}>
            {copy.heroCards.map((card) => (
              <Link
                key={card.type}
                href={card.href}
                className={`${heroStyles.showcaseCard} ${
                  card.type === 'web'
                    ? heroStyles.webCard
                    : heroStyles.mobileCard
                }`}
              >
                <div className={heroStyles.deviceStage}>
                  {card.type === 'web' ? <BrowserPreview /> : <PhonePreview />}
                </div>

                <div className={heroStyles.cardFooter}>
                  <div className={heroStyles.cardCopy}>
                    <h2>{card.title}</h2>
                    <p>{card.text}</p>
                  </div>
                  <span className={heroStyles.cardArrow} aria-hidden="true">
                    <ArrowDownRight />
                  </span>
                </div>
              </Link>
          ...
          <div className={heroStyles.heroFooter}>
            <div className={heroStyles.heroActions}>
              <Link
                href={isRussian ? '/contacts_ru' : '/contacts'}
              ...
              <Link
                href={isRussian ? '/projects_ru' : '/projects'}
            ...
            <div
              className={heroStyles.heroMeta}
              aria-label={
                isRussian ? 'Возможности студии' : 'Studio capabilities'
              }
            >
      ...
      <div className={styles.contentSurface}>
        ...
        >
          <div className={styles.sectionHeading}>
            <div>
              <p className={styles.sectionEyebrow}>{copy.servicesEyebrow}</p>
          ...
          <div className={styles.servicesGrid}>
            {copy.services.map((service) => {
              ...
              return (
                <article
                  className={`${styles.glassPanel} ${styles.serviceCard}`}
                  key={service.title}
                >
        ...
        >
          <div className={styles.aboutLogoVisual} aria-hidden="true">
            <RafMinimalizmLogo placement="about" />
          </div>

          <div className={`${styles.glassPanel} ${styles.aboutPanel}`}>
        ...
        >
          <div className={styles.contactHeader}>
            <p className={styles.sectionEyebrow}>{copy.contactEyebrow}</p>
            ...
            <div className={styles.contactActions}>
              ...
              <button
                type="button"
                className={`${styles.actionButton} ${styles.actionButtonGhost} ${styles.mobileContactAction}`}
                onClick={saveContact}
              >
                <span>{copy.saveContactAction}</span>
          ...
          <div className={styles.contactGrid}>
            {copy.channels.map((channel) => {
              ...
              return (
                <a
                  className={`${styles.glassPanel} ${styles.contactCard}`}
                  href={channel.href}
                  key={channel.label}
