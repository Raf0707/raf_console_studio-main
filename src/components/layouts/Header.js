...
function HeaderContent() {
  ...
  const toggleLanguage = () => {
    ...
    const targetLanguage = isRussian
        ? 'en'
        : 'ru';
      ...
      >
        ...
        <div
            className={cn(
                [
                  ...
                  'after:pointer-events-none after:inset-x-[10%] after:top-0 after:-z-10 after:h-px',
        ...
        >
          ...
          <span className="whitespace-nowrap">
            ...
            <span className="whitespace-nowrap font-medium text-[#ad8a70]">
            Studio
          </span>
          </Link>
